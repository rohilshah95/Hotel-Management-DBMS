...
public class DBDemo {
    ...
    public static void main(String[] args) {
        ...
        stmt.executeUpdate("CREATE TABLE HOTEL (ID INT PRIMARY KEY, NAME VARCHAR(32) NOT NULL, ADDRESS VARCHAR(64) NOT NULL, PHONE VARCHAR(32) NOT NULL, MANAGERID INT, CONSTRAINT FOREIGN KEY(MANAGERID) REFERENCES STAFF(ID) ON DELETE CASCADE ON UPDATE CASCADE)");
        stmt.executeUpdate("CREATE TABLE ROOM (NUMBER INT, HOTELID INT, CONSTRAINT FOREIGN KEY(HOTELID) REFERENCES HOTEL(ID) ON DELETE CASCADE ON UPDATE CASCADE, PRIMARY KEY(NUMBER, HOTELID), CATEGORY VARCHAR(32) NOT NULL, RATE FLOAT NOT NULL, AVAILABILITY TINYINT NOT NULL, MAXOCCUPANCY INT NOT NULL)");
